  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 left-4 md:left-10 w-16 h-16 md:w-32 md:h-32 bg-social-purple/10 rounded-md"></div>
        <div className="absolute top-40 right-4 md:right-20 w-12 h-12 md:w-24 md:h-24 bg-social-cyan/10 rounded-md"></div>
        <div className="absolute bottom-32 left-1/4 w-20 h-20 md:w-40 md:h-40 bg-social-orange/10 rounded-md"></div>
        <div className="absolute bottom-20 right-4 md:right-10 w-14 h-14 md:w-28 md:h-28 bg-social-yellow/10 rounded-md"></div>
      </div>
          ...
          <div className={`transition-opacity duration-700 ${showHeadline ? 'opacity-100' : 'opacity-0'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center mb-16 sm:mb-20 px-4">
              <button 
                ...
                className="w-full sm:w-auto px-8 py-4 bg-social-purple text-white font-bold text-base sm:text-lg rounded-lg hover:bg-social-purple/90 transition-colors duration-200 min-h-[52px] flex items-center justify-center"
              >
                Build My Content System
              </button>
              <button 
                onClick={handleExplorePackages}
                className="w-full sm:w-auto px-8 py-4 bg-white border-2 border-social-purple text-corporate-dark font-bold text-base sm:text-lg rounded-lg hover:bg-social-purple hover:text-white transition-colors duration-200 min-h-[52px] flex items-center justify-center"
              >
                Book Strategy Call
              </button>
            </div>
