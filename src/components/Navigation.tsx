...
<div className="flex-shrink-0">
  ...
  >
    <img 
      src="/lovable-uploads/1361e7b6-d134-4a00-b44d-4546f90039d2.png" 
    ...
    <span className="text-foreground font-extrabold tracking-tight text-base sm:text-lg">Palmer House Productions</span>
          ...
          <div className="hidden md:block">
            <div className="flex items-center space-x-6">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent 
                  align="start" 
                  className="w-56 bg-background border border-border shadow-lg rounded-md z-50"
                  sideOffset={5}
                >
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent 
                  align="start" 
                  className="w-48 bg-background border border-border shadow-lg rounded-md z-50"
                  sideOffset={5}
                >
                  <DropdownMenuItem asChild>
                    <Link 
          ...
          <div className="md:hidden">
            <button 
              ...
              className="p-2 text-muted-foreground hover:text-foreground focus:outline-none interactive-element min-h-[44px] min-w-[44px] flex items-center justify-center"
