export const Services = () => {
  return (
    <section id="services" className="py-20 bg-earth-brown-dark">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-warm-cream">What We Offer</h2>
        ...
        <div className="space-y-8 max-w-4xl mx-auto">
          <div className="p-6 bg-earth-brown/50 border border-earth-brown-light rounded-lg hover:border-warm-orange/50 transition-all duration-300 group">
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-xl text-stone-gray max-w-3xl mx-auto leading-relaxed mb-6">
            Built for brands that don't just want content—
          </p>
          <p className="text-xl text-stone-gray max-w-3xl mx-auto leading-relaxed mb-8">
