...
const sections: QuizSection[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 5,
        question: "Do you have video testimonials from clients?",
        type: 'toggle',
        options: ['Yes', 'No']
      }
    ]
  },
  {
    ...
    questions: [
      {
        id: 6,
        question: "How visible are your wins and achievements?",
        type: 'emoji',
        options: ['😢', '😕', '😐', '🙂', '😁']
      },
      {
        id: 7,
        question: "Do you document your team and company culture?",
        type: 'toggle',
        options: ['Yes', 'No']
      }
    ]
...
const characterConfigs = [
  ...
  {
    image: placeholderImage,
    tip: "Your customers are your best marketers!"
  },
  {
    image: placeholderImage,
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 animate-fade-in">
        <div className="bg-white rounded-3xl shadow-xl p-8 lg:p-12 text-center">
          ...
          <h2 className="text-4xl font-bold mb-6 text-gray-800">Your Spotlight Strategy Assessment</h2>
          <p className="text-xl text-gray-600 mb-8">
            Thanks for completing the quiz! Based on your answers, let's discuss how cinematic production can showcase your brand.
          </p>
          <Link to="/contact" className="inline-block bg-purple-500 text-white font-semibold px-8 py-4 rounded-full hover:bg-purple-600 transition-colors shadow-lg">
            Book Strategy Call
          </Link>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row gap-6 lg:gap-8 items-start">
          ...
          <div className="hidden md:flex md:flex-col md:items-center md:w-[350px] lg:w-[450px] flex-shrink-0 md:mt-0 lg:mt-2 md:ml-4 lg:ml-8">
            ...
            />
            <div className="mt-2 lg:mt-3 bg-purple-50 rounded-2xl p-4 lg:p-6 border-2 border-purple-200 shadow-lg animate-scale-in">
