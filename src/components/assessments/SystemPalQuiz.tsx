      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 lg:p-10 mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Link to="/evergreen-pal#quiz" className="group">
              <div className="p-6 rounded-2xl border-2 border-gray-200 hover:border-green-500 transition-all hover:shadow-lg bg-gradient-to-br from-green-50 to-white">
                <div className="text-4xl mb-3">🌲</div>
                <h4 className="font-bold text-lg mb-2 text-gray-800 group-hover:text-green-600 transition-colors">Evergreen Pal Quiz</h4>
                <p className="text-sm text-gray-600 mb-4">For long-form educational content and SEO-driven video strategies</p>
        ...
        <div className="text-center text-gray-600 pb-8">
          <p className="text-lg">Ready to build video systems that scale? <Link to="/contact" className="text-green-500 hover:underline font-semibold">Schedule a free discovery call</Link></p>
        </div>
      </div>
      </div>
    );
