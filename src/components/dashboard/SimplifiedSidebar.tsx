import { Home, Search, Video, User, Sparkles, Maximize, MessageCircle, Settings, LogOut } from 'lucide-react';
...
const toolItems = [
  { title: 'Series Builder', url: '/tools/video-series-builder', icon: Video },
