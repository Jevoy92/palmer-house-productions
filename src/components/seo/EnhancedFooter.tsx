        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a
                href="https://facebook.com/palmerhouseproductions"
                target="_blank"
              ...
              <a
                href="https://instagram.com/palmerhouseproductions"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-white transition-colors"
              ...
              <a
                href="https://youtube.com/@palmerhouseproductions"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-white transition-colors"
              ...
              <a
                href="https://linkedin.com/company/palmer-house-productions"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-white transition-colors"
