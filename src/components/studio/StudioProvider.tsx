...
const demoWorkspace: Workspace = {
  ...
  name: "Nature Works",
  slug: "nature-works-owner-preview",
...
const demoBrand: Brand = {
  ...
  business_name: "Nature Works",
  website: "https://gonatureworks.com",
  industry: "Landscape design, build, and maintenance",
  creator_type: "Business",
  primary_goal: "Sell services",
  description:
    "A Sherwood, Oregon landscape company that designs, installs, and maintains nature-inspired outdoor spaces while solving drainage, irrigation, privacy, slope, and circulation challenges.",
  primary_audience:
    "Homeowners across Portland's west side, Beaverton, Sherwood, West Linn, and Lake Oswego who want beautiful, functional landscapes suited to the Pacific Northwest.",
  offers: [
    "Complimentary landscape consultation",
  ...
  voice_traits: ["Knowledgeable", "Practical", "Natural", "Reassuring"],
  preferred_language:
    "Explain what the site is showing us, connect the parts, and give the homeowner one practical next step.",
  avoid_language: ["dream yard", "luxury oasis", "game-changing", "one-size-fits-all"],
  locations: ["Sherwood", "Beaverton", "Portland west side", "West Linn", "Lake Oswego"],
  platforms: ["Instagram", "Facebook", "YouTube", "Email"],
  calls_to_action: [
    "Schedule a complimentary landscape consultation",
    "Show us the part of your yard that is not working",
  ],
  proof_points: [
    "Over 40 years of landscape experience",
    "Operating in the Pacific Northwest since 2009",
    "Landscape work backed by guarantees and warranties",
    "Oregon landscape contractor license 8868",
    "Certified Arborist WE6979A",
  ],
  content_examples: [],
  ...
  brand_details: {
    ...
    values:
      "Site-specific thinking, durable craft, practical guidance, and respect for the Pacific Northwest.",
    taglines: "Beautiful landscapes that work naturally with the site.",
    photography:
      "Real Pacific Northwest properties, visible site conditions, thoughtful process, and finished landscape details.",
    imageStyle:
      "Natural light, true-to-life greens and stone, practical before-and-after evidence, and no artificial fantasy scenes.",
    competitors:
      "Generic lawn services, one-trade contractors, and landscape plans that ignore drainage or long-term care.",
    customers:
...
const demoBrandReferences: BrandReference[] = [
  ...
  },
  {
    ...
    workspace_id: demoWorkspace.id,
    kind: "guide",
    label: "Nature Works design and build services",
    source_url: "https://gonatureworks.com/services/design-build-services/",
    storage_path: null,
    metadata: { status: "analyzed" },
    created_at: new Date().toISOString(),
  },
...
const previewProfile: Profile = {
  id: "owner-preview",
  avatar_url: null,
  full_name: "Howard Lehmann",
  job_title: "Nature Works owner preview",
...
function buildDemoWorkspaceSeed() {
  ...
  const definitions = [
    {
      id: "nature-works-site-reading",
      topic:
        "The muddy side yard is not just ugly. It is telling us where the water has nowhere to go.",
      goal: "Build authority with long-form content",
      lane: "evergreen",
      daysAgo: 2,
    },
    {
      id: "nature-works-consultation",
      topic:
        "Show homeowners what a complimentary landscape consultation looks for before design begins.",
  ...
  definitions.forEach((definition, campaignIndex) => {
    ...
    campaigns.push({
      ...
      offer: "Schedule a complimentary landscape consultation",
    ...
    calendar.push(
      ...output.schedule.slice(0, 4).map((item, index) => ({
        ...
        notes: "Nature Works owner-preview publishing draft.",
        created_at: created,
        updated_at: created,
      })),
    );
