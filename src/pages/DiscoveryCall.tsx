...
const DiscoveryCallPage = () => {
  return (
    <div className="min-h-screen bg-white">
      <MetaTags 
        title="Free Discovery Call | Video Strategy | Palmer House"
        description="Book a free discovery call to explore video solutions for your business. Map challenges and discover the perfect video strategy for growth."
        ...
        ogDescription="Book a free discovery call to explore video solutions for your business. Map challenges and discover the perfect video strategy for growth."
      />
