        ...
        <section className="pt-24 pb-16 bg-cinematic-charcoal/50 backdrop-blur-sm">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="text-center mb-16">
                <h1 className="text-5xl md:text-7xl font-display font-black mb-8 text-video-white tracking-tight">
                Privacy <span className="text-gradient-1">Policy</span>
              </h1>
              <p className="text-xl md:text-2xl text-video-white/80 mb-8 max-w-3xl mx-auto">
              ...
              <p className="text-lg text-video-white/80 mb-8 max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              <div className="bg-white/10 backdrop-blur-sm border border-white/20 p-8 rounded-3xl video-shadow">
                <h2 className="text-2xl font-bold text-video-white mb-4">Information We Collect</h2>
                <p className="text-video-white/80 mb-6">
                ...
                <h2 className="text-2xl font-bold text-video-white mb-4">How We Use Your Information</h2>
                <p className="text-video-white/80 mb-6">
                ...
                <h2 className="text-2xl font-bold text-video-white mb-4">Information Sharing</h2>
                <p className="text-video-white/80 mb-6">
                  We do not sell, trade, or otherwise transfer your personal information to third parties without your consent, 
                  except as described in this policy.
                </p>

                <h2 className="text-2xl font-bold text-video-white mb-4">Data Security</h2>
                <p className="text-video-white/80 mb-6">
                ...
                <h2 className="text-2xl font-bold text-video-white mb-4">Data Retention</h2>
                <p className="text-video-white/80 mb-6">
                ...
                <h2 className="text-2xl font-bold text-video-white mb-4">Your Rights</h2>
                <p className="text-video-white/80 mb-6">
                ...
                <h2 className="text-2xl font-bold text-video-white mb-4">Children's Privacy</h2>
                <p className="text-video-white/80 mb-6">
                ...
                <h2 className="text-2xl font-bold text-video-white mb-4">Changes to This Policy</h2>
                <p className="text-video-white/80 mb-6">
                ...
                <h2 className="text-2xl font-bold text-video-white mb-4">Contact Us</h2>
                <p className="text-video-white/80">
                  If you have any questions about this Privacy Policy, please contact us at{" "}
                  <a href="mailto:info@palmerhouseproductions.com" className="text-gradient-1 hover:underline">
