          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="prose prose-lg max-w-none">
              <div className="bg-white/10 backdrop-blur-sm border border-white/20 p-8 rounded-3xl video-shadow">
                <h2 className="text-2xl font-bold text-video-white mb-4">Acceptance of Terms</h2>
                ...
                <h2 className="text-2xl font-bold text-video-white mb-4">Services</h2>
                <p className="text-video-white/80 mb-6">
                  Palmer House Productions provides video production services, coaching, and digital downloads. 
                  We reserve the right to modify or discontinue services at any time.
                </p>

                <h2 className="text-2xl font-bold text-video-white mb-4">Payment Terms</h2>
                <p className="text-video-white/80 mb-6">
                  Payment terms will be outlined in individual service agreements. All fees are non-refundable 
                  unless otherwise specified in writing.
                </p>

                <h2 className="text-2xl font-bold text-video-white mb-4">Intellectual Property</h2>
                <p className="text-video-white/80 mb-6">
                ...
                <h2 className="text-2xl font-bold text-video-white mb-4">Limitation of Liability</h2>
                <p className="text-video-white/80 mb-6">
                ...
                <h2 className="text-2xl font-bold text-video-white mb-4">Governing Law</h2>
                <p className="text-video-white/80 mb-6">
                  These terms shall be governed by and construed in accordance with the laws of the 
                  State of Washington, without regard to its conflict of law provisions.
                </p>

                <h2 className="text-2xl font-bold text-video-white mb-4">Changes to Terms</h2>
                <p className="text-video-white/80 mb-6">
                ...
                <h2 className="text-2xl font-bold text-video-white mb-4">Contact Information</h2>
