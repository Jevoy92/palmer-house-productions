            ...
            <main className="flex-1 bg-gradient-to-br from-background via-muted/20 to-background">
              <div className="container mx-auto px-4 py-8 max-w-5xl">
                <div className="mb-12 text-center">
                  <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-pal-orange to-pal-purple flex items-center justify-center shadow-lg">
                ...
                <Card className="max-w-2xl mx-auto bg-gradient-to-br from-pal-orange/5 to-pal-purple/5">
                  <CardHeader className="text-center pb-4">
                    <div className="w-16 h-16 mx-auto mb-4 rounded-xl bg-gradient-to-br from-pal-orange to-pal-purple flex items-center justify-center">
