...
import { PageShell, PageHero, Section, Card, CardGrid, CtaBand, Eyebrow } from "@/components/site/PageShell";
...
const PILLARS = [
  { title: "Spotlight", body: "Professional brand stories that showcase your team, culture, and expertise to the world.", index: "Brand Trust" },
  { title: "Reel", body: "Short-form content engineered for social platforms — hooks, cuts, and calls-to-action that convert.", index: "Social Reach" },
  { title: "Evergreen", body: "Timeless assets — FAQs, onboarding, training — that work 24/7 without repeating yourself.", index: "Time Saved" },
  { title: "System", body: "Full content ecosystems that tie everything together into a measurable, scalable machine.", index: "Efficiency" },
];

const APPROACH = [
  { n: "01", title: "Discovery", body: "We listen before we film. Map your goals, audience, and bottlenecks." },
  { n: "02", title: "Strategy", body: "Design a video system that solves problems — not just fills a feed." },
  { n: "03", title: "Production", body: "Professional shoots with a team that makes you feel confident on camera." },
  { n: "04", title: "Launch", body: "Delivery, optimization, and ongoing support to keep your system sharp." },
];
...
export const Route = createFileRoute("/about-us")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Palmer House Productions is a translation company that uses cameras and editing as tools — turning messy thoughts into clear messages and chaos into systems." },
      { property: "og:title", content: "About Us | Palmer House Productions" },
      { property: "og:description", content: "We don't make videos. We transform how your business communicates." },
...
function AboutUsPage() {
  return (
    <PageShell>
      ...
      <Section muted>
        <div className="mx-auto grid max-w-4xl gap-4 sm:grid-cols-2">
          {TRANSFORMATIONS.map((t) => (
            <div key={t.from} className="flex items-center justify-between gap-3 rounded-2xl border border-border bg-card px-5 py-4 shadow-soft">
      ...
      <Section eyebrow="What We Build" title="Four Pillars of Video Strategy" subtitle="Every project maps to one of four strategic outcomes — designed to solve real business problems." muted>
        <CardGrid cols={4}>
          {PILLARS.map((p) => (
      ...
      <Section eyebrow="Our Approach" title="Built Like a Workshop, Not an Assembly Line" subtitle="Every project starts with understanding — not a template. We map your pain points, design the system, produce with precision, and launch with confidence.">
        <CardGrid cols={4}>
          {APPROACH.map((a) => (
      ...
      <Section muted>
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-sm font-semibold text-muted-foreground">Jevoy Palmer, Founder &amp; Lead Creative Guide</p>
        </div>
      </Section>

      <Section eyebrow="Our Team" title="The Palmer House Team" subtitle="Meet the video production professionals who bring your stories to life.">
        <div className="mx-auto max-w-2xl rounded-2xl border border-border bg-card p-8 text-center shadow-soft">
          ...
          <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
            Jevoy is the visionary behind Palmer House Productions. A filmmaker, strategist, and storyteller at heart, he leads with the belief that video isn't just content — it's a business tool. Known for making even the most camera-shy clients feel confident on set, he's passionate about turning complex ideas into cinematic clarity.
          </p>
        </div>
      ...
      <Section eyebrow="Our Values" title="What We Stand For" subtitle="These principles guide every project and client relationship." muted>
        <CardGrid cols={2}>
          {VALUES.map((v) => (
      ...
      <Section>
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="font-display text-2xl font-extrabold sm:text-3xl">Our Work Doesn't Shout. It Echoes.</h2>
      ...
      <CtaBand title="Ready to Tell Your Story?" subtitle="Let's turn your expertise into an asset that works for you every day." />
    </PageShell>
  );
}
