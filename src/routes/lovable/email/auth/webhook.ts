...
// Configuration
const SITE_NAME = "palmer-house-productions";
const SENDER_DOMAIN = "notify.palmerhouseproductions.com";
const ROOT_DOMAIN = "palmerhouseproductions.com";
const FROM_DOMAIN = "palmerhouseproductions.com";
    ...
    handlers: {
      POST: async ({ request }) => {
        ...
        if (!emailType || !recipient) {
          console.error("Webhook payload missing email data", { run_id });
          return Response.json({ error: "Invalid webhook payload" }, { status: 400 });
        }
