      ...
      <Section muted eyebrow="Meet Your Editor" title="Spotlight Pal, Your Post-Production Expert">
        <div className="mx-auto max-w-2xl rounded-2xl border border-border bg-card p-8 text-center shadow-soft">
          <p className="text-muted-foreground">
            ...
            content. With expertise in editing, color grading, and audio post-production, Spotlight
            ensures every frame tells your story perfectly.
          </p>
          ...
          <Link
            to="/spotlight-pal"
            className="mt-5 inline-block text-sm font-semibold text-gradient-brand"
          >
        ...
        <CardGrid cols={3}>
          {related.map((r) => (
            <div key={r.title} className="rounded-2xl border border-border bg-card p-6 shadow-soft">
              ...
              <Link
                to={r.to}
                className="mt-3 inline-block text-sm font-semibold text-gradient-brand"
              >
                Learn More →
              </Link>
            </div>
